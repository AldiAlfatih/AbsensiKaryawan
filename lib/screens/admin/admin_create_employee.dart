...
/// NIK is stored as-is; Firebase Auth email = NIK@absensi.com (hidden).
...
class _AdminCreateEmployeeScreenState
  ...
  Future<void> _createAccount() async {
    ...
    final result =
        await ref.read(authNotifierProvider.notifier).createEmployee(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: _success ? _SuccessView(nik: _createdNik!, onAddAnother: _reset) : Form(
          key: _formKey,
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) {
                  ...
                  if (v.contains(' ')) return 'NIK tidak boleh mengandung spasi';
                  return null;
                },
